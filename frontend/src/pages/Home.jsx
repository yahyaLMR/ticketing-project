...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="relative bg-gray-900 text-white overflow-hidden">
        ...
        <div className="relative container mx-auto px-4 py-24 md:py-32 flex flex-col items-center text-center">
          <h1 className="text-5xl md:text-7xl font-extrabold mb-6 tracking-tight leading-tight">
            Experience the <span className="text-transparent bg-clip-text bg-linear-to-r from-blue-400 to-purple-400">Extraordinary</span>
          </h1>
          ...
          <button 
            ...
            className="group bg-blue-600 hover:bg-blue-700 text-white text-lg font-bold py-4 px-8 rounded-full transition-all duration-300 shadow-lg hover:shadow-blue-500/50 flex items-center space-x-2"
          >
      ...
      <div className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="p-6 rounded-2xl bg-gray-50 hover:bg-blue-50 transition-colors duration-300 text-center">
              <div className="w-16 h-16 bg-blue-100 text-blue-600 rounded-full flex items-center justify-center mx-auto mb-4">
                <SpeedIcon sx={{ fontSize: 32 }} />
              </div>
              <h3 className="text-xl font-bold mb-2 text-gray-800">Instant Booking</h3>
              <p className="text-gray-600">Secure your spot in seconds with our lightning-fast reservation system.</p>
            </div>
            <div className="p-6 rounded-2xl bg-gray-50 hover:bg-purple-50 transition-colors duration-300 text-center">
              <div className="w-16 h-16 bg-purple-100 text-purple-600 rounded-full flex items-center justify-center mx-auto mb-4">
                <SecurityIcon sx={{ fontSize: 32 }} />
              </div>
              <h3 className="text-xl font-bold mb-2 text-gray-800">Secure Payments</h3>
              <p className="text-gray-600">Your transactions are protected with top-tier security encryption.</p>
            </div>
            <div className="p-6 rounded-2xl bg-gray-50 hover:bg-pink-50 transition-colors duration-300 text-center">
      ...
      {/* Events Section */}
      <div id="events-section" className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Upcoming Events</h2>
            <p className="text-gray-600 mb-8">Don't miss out on these amazing experiences</p>
                ...
                >
                  <div className="relative overflow-hidden h-56">
                    {event.imageURL ? (
                      ...
                      <div className="w-full h-full bg-linear-to-br from-blue-400 to-purple-500 flex items-center justify-center text-white">
